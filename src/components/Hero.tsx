          ...
          <div className="lg:col-span-12 xl:col-span-5 flex justify-center relative select-none mt-2 lg:mt-0">
            <div className="relative w-60 h-60 sm:w-68 h-68 lg:w-76 lg:h-76">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-48 h-48 lg:w-56 lg:h-56 border border-gold-500/30 rounded-xl bg-white backdrop-blur-md p-4 flex flex-col justify-between shadow-lg relative group hover:border-gold-500 duration-500 overflow-hidden">
